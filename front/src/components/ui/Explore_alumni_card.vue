<template>
  <section>
    ...
    <div>
      <div class="alumni-top">
        ...
        <v-row class="ml-12 mr-12">
          ...
          <v-col>
            <v-select
              class="filter_company"
              v-model="companyName"
              @change="sort('company_id', companyName)"
              :items="listCompany"
    ...
    <!-- End Search and Sort -->    
    <div v-if="!isDataAvailable" align="center" class="mt-12"> <h2>No Data Available</h2></div>
              ...
              <div class="text-overline mb-8">
                ...
                <div class="d-flex">
                  <div class="user-profile">
                    ...
                    >
                      <img
                        src="https://www.portal.chat/img/avatar.svg"
                        alt=""
                      />
                    </v-avatar>
                    <v-avatar
                    ...
                    <v-list-item-title
                      class="text-h6"
                      align="center"
                      style="margin-bottom: -40px; color: #2196f3"
                    >
                      {{ user.firstName }}
                    </v-list-item-title>
                  </div>
                  ...
                  <div class="d-flex user-info">
                    <div class="userSkill d-flex mt-4 mr-4">
                      <v-icon small color="blue" style="margin-top: -8px" dark>
                        mdi-lightbulb-on
                      </v-icon>
                      <h5
                        class="ml-2 mt-2"
                        v-html="skill(user.skills, user.major)"
                      ></h5>
                    </div>
                    ...
                    <div class="UserEmail d-flex mt-4">
                      <v-icon style="margin-top: -5px" small color="blue" dark>
                        mdi-email
                      </v-icon>
                      <h5 class="ml-2 mt-2">
                        {{ user.email }}
...
export default {
  ...
  methods: {
    ...
    //___________________ sort ____________________//
    getCompany() {
